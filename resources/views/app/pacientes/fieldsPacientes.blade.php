...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group">
            ...
            @if ($model)
            <select-combustibles :selected="{{ $model->sexo_full}}" url="/api-app/sexos" nombre="sexo_id" label="sexo_full" />
            @else
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Fecha Cita</label>
                ...
                @if ($model)
                <select-combustibles :selected="{{ $model->fecha_cita}}" url="/api-app/citas" nombre="cita_id" label="fecha_cita" />
                @else
        ...
        <div class="form-group">
            ...
            <label for="exampleInputEmail1">Hora Cita</label>
                ...
                @if ($model)
                <select-combustibles :selected="{{ $model->hora_cita}}" url="/api-app/citas" nombre="cita_id" label="hora_cita" />
                @else
